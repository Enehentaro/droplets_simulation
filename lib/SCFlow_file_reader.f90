...
program SCFlow_file_reader
    ...
    do step = 0,10000
        ...
        !call make_face2cells(this) 
        !call make_cell2faces(this) 
...
contains 
    ...
    subroutine destructor(this)
        implicit none
        type(SCFlow_grid_t),intent(inout) :: this
...
end program SCFlow_file_reader
